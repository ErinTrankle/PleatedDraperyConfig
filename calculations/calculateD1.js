//calculate D1 - Draperies and Valances wholesale price
	...
	if (COM == false) {
		...
		if (lining == false) {
			...
			////////////// > 108 <= 120 ////////////////
				...
				let x = Math.round(totalWidths * COMunlinedLabor108to120 + totalWidths);
			...
			////////////// > 120 ////////////////
				...
				let extraCostPer12Inches = Math.round(
					totalWidths * COMunlinedEachAdditional12
				);
